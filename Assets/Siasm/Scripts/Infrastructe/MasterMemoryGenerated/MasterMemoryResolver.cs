...
namespace Siasm
{
    ...
    internal static class MasterMemoryResolverGetFormatterHelper
    {
        ...
        static MasterMemoryResolverGetFormatterHelper()
        {
            ...
            {
                {typeof(BattleCardMasterData[]), 0 },
                {typeof(BattleFighterMasterData[]), 1 },
            };
        }
        ...
        internal static object GetFormatter(Type t)
        {
            ...
            switch (key)
            {
                case 0: return new MessagePack.Formatters.ArrayFormatter<BattleCardMasterData>();
                case 1: return new MessagePack.Formatters.ArrayFormatter<BattleFighterMasterData>();
                default: return null;
            }
        }
    }
