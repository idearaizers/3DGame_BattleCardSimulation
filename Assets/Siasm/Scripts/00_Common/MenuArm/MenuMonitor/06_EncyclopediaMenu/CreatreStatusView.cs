...
namespace Siasm
{
    public class CreatreStatusView : MonoBehaviour
    {
        ...
        {
            // 
            var battleFighterStatusModel = BaseUseCase.CreateBattleFighterStatusModelOfCreature(currentCreatureRecordModel.CreatureId, currentCreatureRecordModel.CreatureLevel);
