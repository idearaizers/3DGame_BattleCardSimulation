namespace Siasm
{
    public sealed class GuardReelUpAbnormalConditionModel : BaseAbnormalConditionModel
    {
        public GuardReelUpAbnormalConditionModel(AbnormalConditionType abnormalConditionType, BattleCardAbilityModel battleCardAbilityModel) :
